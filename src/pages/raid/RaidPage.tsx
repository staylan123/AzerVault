...
const REGIONS = ["world", "us", "eu", "kr", "tw"] as const
...
const RaidPage = () => {
  ...
  const [difficulty, setDifficulty] = useState<string>("mythic")
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (selectedRaid) getHallOfFame(selectedRaid, difficulty, region)
  }
